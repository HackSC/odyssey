...
const slackAnnouncementsRouter = require("./api/slackAnnouncement");
...
server.use("/api/slackAnnouncement", slackAnnouncementsRouter);
...
server.use("/admin/api/slackAnnouncement", slackAnnouncementsRouter);
